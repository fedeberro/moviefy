export const verificationEmailBody = (username, token, email) => {
  const link = `https://my-moviefy.vercel.app/registrarse/verificar-email?email=${email}`;
  return `<!DOCTYPE html>
<html
                          ...
                          >
                            ...
                            >
                              <span style="font-size: 16px"
                                >¡Gracias por registrarte en Moviefy!</span
                              >
                            </p>
                            <p
                              style="
                            ...
                            >
                              <span style="font-size: 16px"
                                >Para completar tu registro y empezar a crear
                                tus listas,
                                <strong
                                  >por favor verifica tu dirección de
                                  e-mail</strong
                                >.</span
                              >
                            </p>
                            ...
                            >
                              <br /><span style="font-size: 16px"
                                >Ingresá el siguiente token de verificación en
                            ...
                            >
                              <span style="font-size: 16px"
                                >Si no fuiste vos el que solicitó esta cuenta,
                                por favor ignorá este mensaje.</span
                              >
                            </p>
                            <p
                              style="
