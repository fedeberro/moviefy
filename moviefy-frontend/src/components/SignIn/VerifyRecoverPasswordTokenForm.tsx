...
import { sendRecoveryEmail, verifyRecoveryToken } from "@/api/recoverPassword";
...
export function VerifyRecoverPasswordTokenForm() {
  ...
  function onSubmit(data: z.infer<typeof FormSchema>) {
    verifyRecoveryToken(data.email, data.token)
      .then(() => {
        navigate("/iniciar-sesion/restablecer-contraseña/restablecer", {
